...
DEFINE_string(synerkv_path, "/tmp/synerkv",
  "Path for SynerKV");

DEFINE_string(bucket_name, "testbucket",
  "Bucket name");
  
DEFINE_string(region, "ap-northeast-1",
  "Your Region");
...
DEFINE_bool(
    upload_while_generate, true,
    "support_upload_while_generate.");
 ...
 private:
  ...
  void OpenDb(Options options, const std::string& db_name,
    ...
    if (FLAGS_num_column_families > 1) {
      ...
      std::string kDBPath = FLAGS_synerkv_path;
      std::string kBucketSuffix = FLAGS_bucket_name;
      std::string kRegion = FLAGS_region;
      ...
      cloudoptions.hyper_level = FLAGS_hyper_level;
      cloudoptions.upload_while_generate = FLAGS_upload_while_generate;
      std::cout << "setting hyper_level:" << cloudoptions.hyper_level <<std::endl;
